...
_NOT_SUPPORTED_CASES = [
    ...
    ("list_pull_request_checks", lambda a: a.list_pull_request_checks(1), f"{_REPO_WEB}/pulls/1"),
    ("list_pull_request_files", lambda a: a.list_pull_request_files(1), f"{_REPO_WEB}/pulls/1"),
    ("list_pull_request_commits", lambda a: a.list_pull_request_commits(1), f"{_REPO_WEB}/pulls/1"),
    ("list_requested_reviewers", lambda a: a.list_requested_reviewers(1), f"{_REPO_WEB}/pulls/1"),
    ("request_reviewers", lambda a: a.request_reviewers(1, ["reviewer"]), f"{_REPO_WEB}/pulls/1"),
    ("remove_reviewers", lambda a: a.remove_reviewers(1, ["reviewer"]), f"{_REPO_WEB}/pulls/1"),
    (
        "update_pull_request_branch",
        lambda a: a.update_pull_request_branch(1),
        f"{_REPO_WEB}/pulls/1",
    ),
    ("enable_auto_merge", lambda a: a.enable_auto_merge(1), f"{_REPO_WEB}/pulls/1"),
    ("dismiss_review", lambda a: a.dismiss_review(1, 2), f"{_REPO_WEB}/pulls/1"),
    ("mark_pull_request_ready", lambda a: a.mark_pull_request_ready(1), f"{_REPO_WEB}/pulls/1"),
    (
        "update_pull_request",
        lambda a: a.update_pull_request(1, title="New"),
        f"{_REPO_WEB}/pulls/1",
    ),
    ("list_reviews", lambda a: a.list_reviews(1), f"{_REPO_WEB}/pulls/1"),
    ("create_review", lambda a: a.create_review(1, state="approve"), f"{_REPO_WEB}/pulls/1"),
