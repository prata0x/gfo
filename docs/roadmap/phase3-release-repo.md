...
1. [ ] **Release download** (#7) — リリースアセットのダウンロード。5サービス対応可能
2. [ ] **Release upload** (#8) — リリースアセットのアップロード。4サービス対応可能
3. [ ] **Release assets 管理** (#27) — アセットの list/delete。4サービス対応可能
4. [ ] **Release latest** (#37) — 最新リリースの取得。5サービス対応可能
5. [ ] **Raw API call** (#22) — 任意の API エンドポイント呼び出し。全9サービス対応可能
6. [ ] **Repo update** (#12) — リポジトリ設定変更。8サービス対応可能
7. [ ] **Repo archive** (#13) — リポジトリのアーカイブ。6サービス対応可能
8. [ ] **Repo compare** (#35) — ブランチ/コミット間の比較情報取得。6サービス対応可能
9. [ ] **Repo topics** (#34) — リポジトリのトピック/タグ管理。4サービス対応可能
10. [ ] **Repo languages** (#36) — リポジトリの言語統計取得。4サービス対応可能
