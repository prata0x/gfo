...
1. [x] **PR diff** (#3) — PR の差分をターミナルに表示。6サービス対応可能
2. [x] **PR checks** (#4) — PR に紐づく CI ステータス一覧。7サービス対応可能
3. [x] **PR files** (#30) — 変更ファイル一覧取得。6サービス対応可能
4. [x] **PR commits** (#31) — PR のコミット一覧取得。6サービス対応可能
5. [x] **PR requested reviewers** (#29) — レビュアーリクエスト。6サービス対応可能
6. [x] **PR update branch** (#32) — ベースブランチを head にマージして最新化。4サービス対応可能
7. [x] **PR auto-merge** (#47) — CI パス後の自動マージ設定。5サービス対応可能
8. [x] **PR review dismiss** (#48) — レビューの却下/取り消し。4サービス対応可能
9. [x] **PR ready** (#18) — ドラフト PR を通常 PR に変更。6サービス対応可能
