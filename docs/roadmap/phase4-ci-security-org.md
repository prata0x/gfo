...
1. [ ] **GPG Key 管理** (#14) — GPG Key の list/create/delete。5サービス対応可能
2. [ ] **CI trigger** (#15) — パイプラインの手動トリガー。6サービス対応可能
3. [ ] **CI retry** (#16) — 失敗パイプラインの再実行。6サービス対応可能
4. [ ] **CI logs** (#17) — パイプラインのログ取得。6サービス対応可能
5. [ ] **Tag protections** (#43) — タグ保護ルールの管理。4サービス対応可能
6. [ ] **Org create / delete** (#26) — 組織の作成・削除。8サービス対応可能
7. [ ] **Repo migrate** (#24) — 外部リポジトリのインポート/移行。6サービス対応可能
8. [ ] **Issue templates** (#50) — Issue テンプレートの一覧取得。5サービス対応可能
