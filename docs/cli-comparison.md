...
| 本文 | `--body` | `--body` | `--description` | `--description` | `--body` / `--body-file` |
...
| ファイル添付 | 別途 `asset upload` | 位置引数 | `--assets-links` | `--asset` | `--attach` |
...
| オプション | gfo | gh | glab | tea | fj |
|---|---|---|---|---|---|
| リネーム | `--new-name` | `--name` | `---` | `--name` | `--name` / `-n` |
| 色 | `--color` | `--color` | `---` | `--color` | `--color` / `-c` |
| 説明 | `--description` | `--description` | `---` | `--description` | `--description` / `-d` |
| 排他ラベル | `---` | `---` | `---` | `---` | `--exclusive` / `-e` |
| アーカイブ | `---` | `---` | `---` | `---` | `--archived` / `-a` |
