...
_SAFETY_MAP: dict[tuple[str, str | None], tuple[bool, bool, bool, bool, bool]] = {
    ...
    ("auth", "token"): (False, False, True, False, False),
    ("auth", "logout"): (False, False, False, False, False),
    ("completion", None): (False, False, False, False, False),
    ("config", "get"): (False, False, False, False, False),
    ("config", "set"): (False, False, False, False, False),
    ("config", "list"): (False, False, False, False, False),
    ("config", "unset"): (False, False, False, False, False),
    ("config", "path"): (False, False, False, False, False),
    ("pr", "list"): (False, False, False, False, False),
    ("pr", "create"): (False, False, False, True, False),
    ("pr", "view"): (False, False, False, False, False),
    ("pr", "merge"): (False, False, False, True, False),
    ("pr", "close"): (False, False, False, True, False),
    ("pr", "checkout"): (False, False, False, False, True),
    ("pr", "edit"): (False, False, False, True, False),
    ("pr", "reopen"): (False, False, False, True, False),
    ("pr", "lock"): (False, False, False, True, False),
    ("pr", "unlock"): (False, False, False, True, False),
    ("pr", "diff"): (False, False, False, False, False),
    ("pr", "checks"): (False, False, False, False, False),
    ("pr", "files"): (False, False, False, False, False),
    ("pr", "commits"): (False, False, False, False, False),
    ("pr", "reviewers"): (False, False, False, True, False),
    ("pr", "update-branch"): (False, False, False, True, False),
    ("pr", "ready"): (False, False, False, True, False),
    ("pr", "status"): (False, False, False, False, False),
    ("pr", "subscribe"): (False, False, False, True, False),
    ("pr", "unsubscribe"): (False, False, False, True, False),
    ("issue", "list"): (False, False, False, False, False),
    ("issue", "create"): (False, False, False, True, False),
    ("issue", "view"): (False, False, False, False, False),
    ("issue", "close"): (False, False, False, True, False),
    ("issue", "lock"): (False, False, False, True, False),
    ("issue", "unlock"): (False, False, False, True, False),
    ("issue", "delete"): (True, True, False, True, False),
    ("issue", "edit"): (False, False, False, True, False),
    ("issue", "reopen"): (False, False, False, True, False),
    ("issue-template", "list"): (False, False, False, False, False),
    ("repo", "list"): (False, False, False, False, False),
    ("repo", "create"): (False, False, False, True, False),
    ("repo", "clone"): (False, False, False, False, True),
    ("repo", "view"): (False, False, False, False, False),
    ("repo", "delete"): (True, True, False, True, False),
    ("repo", "fork"): (False, False, False, True, False),
    ("repo", "sync"): (False, False, False, True, False),
    ("repo", "edit"): (False, False, False, True, False),
    ("repo", "archive"): (True, True, False, True, False),
    ("repo", "unarchive"): (False, False, False, True, False),
    ("repo", "languages"): (False, False, False, False, False),
    ("repo", "topics"): (False, False, False, True, False),
    ("repo", "compare"): (False, False, False, False, False),
    ("repo", "contributors"): (False, False, False, False, False),
    ("repo", "migrate"): (False, False, False, True, False),
    ("release", "list"): (False, False, False, False, False),
    ("release", "create"): (False, False, False, True, False),
    ("release", "delete"): (True, True, False, True, False),
    ("release", "view"): (False, False, False, False, False),
    ("release", "edit"): (False, False, False, True, False),
    ("release", "asset"): (True, True, False, True, False),
    ("label", "list"): (False, False, False, False, False),
    ("label", "create"): (False, False, False, True, False),
    ("label", "delete"): (True, True, False, True, False),
    ("label", "edit"): (False, False, False, True, False),
    ("milestone", "list"): (False, False, False, False, False),
    ("milestone", "create"): (False, False, False, True, False),
    ("milestone", "delete"): (True, True, False, True, False),
    ("milestone", "view"): (False, False, False, False, False),
    ("milestone", "edit"): (False, False, False, True, False),
    ("milestone", "close"): (False, False, False, True, False),
    ("milestone", "reopen"): (False, False, False, True, False),
    ("pr", "comment"): (True, True, False, True, False),
    ("issue", "comment"): (True, True, False, True, False),
    ("pr", "review"): (False, False, False, True, False),
    ("branch", "view"): (False, False, False, False, False),
    ("branch", "list"): (False, False, False, False, False),
    ("branch", "create"): (False, False, False, True, False),
    ("branch", "delete"): (True, True, False, True, False),
    ("tag", "view"): (False, False, False, False, False),
    ("tag", "list"): (False, False, False, False, False),
    ("tag", "create"): (False, False, False, True, False),
    ("tag", "delete"): (True, True, False, True, False),
    ("status", "list"): (False, False, False, False, False),
    ("status", "create"): (False, False, False, True, False),
    ("file", "get"): (False, False, False, False, False),
    ("file", "put"): (False, False, False, True, False),
    ("file", "delete"): (True, True, False, True, False),
    ("webhook", "list"): (False, False, False, False, False),
    ("webhook", "create"): (False, False, False, True, False),
    ("webhook", "delete"): (True, True, False, True, False),
    ("webhook", "test"): (False, False, False, True, False),
    ("webhook", "edit"): (False, False, False, True, False),
    ("deploy-key", "view"): (False, False, False, False, False),
    ("deploy-key", "list"): (False, False, False, False, False),
    ("deploy-key", "create"): (False, False, False, True, False),
    ("deploy-key", "delete"): (True, True, False, True, False),
    ("collaborator", "list"): (False, False, False, False, False),
    ("collaborator", "add"): (False, False, False, True, False),
    ("collaborator", "remove"): (True, True, False, True, False),
    ("ci", "list"): (False, False, False, False, False),
    ("ci", "view"): (False, False, False, False, False),
    ("ci", "cancel"): (False, False, False, True, False),
    ("ci", "delete"): (True, True, False, True, False),
    ("ci", "trigger"): (False, False, False, True, False),
    ("ci", "retry"): (False, False, False, True, False),
    ("ci", "logs"): (False, False, False, False, False),
    ("ci", "watch"): (False, False, False, False, False),
    ("ci", "download"): (False, False, False, False, False),
    ("ci", "workflow"): (False, False, False, True, False),
    ("ci", "artifact"): (False, False, False, False, False),
    ("user", "whoami"): (False, False, False, False, False),
    ("search", "repos"): (False, False, False, False, False),
    ("search", "issues"): (False, False, False, False, False),
    ("wiki", "list"): (False, False, False, False, False),
    ("wiki", "view"): (False, False, False, False, False),
    ("wiki", "create"): (False, False, False, True, False),
    ("wiki", "edit"): (False, False, False, True, False),
    ("wiki", "delete"): (True, True, False, True, False),
    ("issue", "reaction"): (False, False, False, True, False),
    ("issue", "depends"): (False, False, False, True, False),
    ("issue", "timeline"): (False, False, False, False, False),
    ("issue", "subscribe"): (False, False, False, True, False),
    ("issue", "unsubscribe"): (False, False, False, True, False),
    ("issue", "pin"): (False, False, False, True, False),
    ("issue", "unpin"): (False, False, False, True, False),
    ("issue", "time"): (True, True, False, True, False),
    ("issue", "migrate"): (False, False, False, True, False),
    ("issue", "status"): (False, False, False, False, False),
    ("issue", "develop"): (False, False, False, True, False),
    ("search", "prs"): (False, False, False, False, False),
    ("search", "commits"): (False, False, False, False, False),
    ("search", "code"): (False, False, False, False, False),
    ("label", "clone"): (False, False, False, True, False),
    ("wiki", "revisions"): (False, False, False, False, False),
    ("repo", "mirror"): (True, True, False, True, False),
    ("repo", "transfer"): (True, True, False, True, False),
    ("repo", "star"): (False, False, False, True, False),
    ("repo", "unstar"): (False, False, False, True, False),
    ("package", "list"): (False, False, False, False, False),
    ("package", "view"): (False, False, False, False, False),
    ("package", "delete"): (True, True, False, True, False),
    ("branch-protect", "list"): (False, False, False, False, False),
    ("branch-protect", "view"): (False, False, False, False, False),
    ("branch-protect", "set"): (False, False, False, True, False),
    ("branch-protect", "remove"): (True, True, False, True, False),
    ("tag-protect", "list"): (False, False, False, False, False),
    ("tag-protect", "create"): (False, False, False, True, False),
    ("tag-protect", "edit"): (False, False, False, True, False),
    ("tag-protect", "delete"): (True, True, False, True, False),
    ("notification", "list"): (False, False, False, False, False),
    ("notification", "read"): (False, False, False, True, False),
    ("org", "list"): (False, False, False, False, False),
    ("org", "view"): (False, False, False, False, False),
    ("org", "members"): (False, False, False, False, False),
    ("org", "repos"): (False, False, False, False, False),
    ("org", "create"): (False, False, False, True, False),
    ("org", "edit"): (False, False, False, True, False),
    ("org", "delete"): (True, True, False, True, False),
    ("secret", "list"): (False, False, False, False, False),
    ("secret", "set"): (False, False, False, True, False),
    ("secret", "delete"): (True, True, False, True, False),
    ("variable", "list"): (False, False, False, False, False),
    ("variable", "set"): (False, False, False, True, False),
    ("variable", "get"): (False, False, False, False, False),
    ("variable", "delete"): (True, True, False, True, False),
    ("ssh-key", "view"): (False, False, False, False, False),
    ("ssh-key", "list"): (False, False, False, False, False),
    ("ssh-key", "create"): (False, False, False, True, False),
    ("ssh-key", "delete"): (True, True, False, True, False),
    ("gpg-key", "view"): (False, False, False, False, False),
    ("gpg-key", "list"): (False, False, False, False, False),
    ("gpg-key", "create"): (False, False, False, True, False),
    ("gpg-key", "delete"): (True, True, False, True, False),
    ("browse", None): (False, False, False, False, False),
    ("api", None): (True, False, False, True, False),
    ("batch", "pr"): (False, False, False, True, False),
}

# 孫サブコマンドの安全性メタデータ（#57）。
_GRANDCHILD_SAFETY_MAP: dict[tuple[str, str, str], tuple[bool, bool, bool, bool, bool]] = {
    ("pr", "reviewers", "list"): (False, False, False, False, False),
    ("pr", "reviewers", "add"): (False, False, False, True, False),
    ("pr", "reviewers", "remove"): (False, False, False, True, False),
    ("repo", "topics", "list"): (False, False, False, False, False),
    ("repo", "topics", "add"): (False, False, False, True, False),
    ("repo", "topics", "remove"): (False, False, False, True, False),
    ("repo", "topics", "set"): (False, False, False, True, False),
    ("release", "asset", "list"): (False, False, False, False, False),
    ("release", "asset", "upload"): (False, False, False, True, False),
    ("release", "asset", "download"): (False, False, False, False, False),
    ("release", "asset", "edit"): (False, False, False, True, False),
    ("release", "asset", "delete"): (True, True, False, True, False),
    ("pr", "comment", "list"): (False, False, False, False, False),
    ("pr", "comment", "create"): (False, False, False, True, False),
    ("pr", "comment", "edit"): (False, False, False, True, False),
    ("pr", "comment", "delete"): (True, True, False, True, False),
    ("issue", "comment", "list"): (False, False, False, False, False),
    ("issue", "comment", "create"): (False, False, False, True, False),
    ("issue", "comment", "edit"): (False, False, False, True, False),
    ("issue", "comment", "delete"): (True, True, False, True, False),
    ("pr", "review", "list"): (False, False, False, False, False),
    ("pr", "review", "create"): (False, False, False, True, False),
    ("pr", "review", "dismiss"): (False, False, False, True, False),
    ("ci", "workflow", "list"): (False, False, False, False, False),
    ("ci", "workflow", "enable"): (False, False, False, True, False),
    ("ci", "workflow", "disable"): (False, False, False, True, False),
    ("ci", "artifact", "list"): (False, False, False, False, False),
    ("ci", "artifact", "download"): (False, False, False, False, False),
    ("issue", "reaction", "list"): (False, False, False, False, False),
    ("issue", "reaction", "add"): (False, False, False, True, False),
    ("issue", "reaction", "remove"): (False, False, False, True, False),
    ("issue", "depends", "list"): (False, False, False, False, False),
    ("issue", "depends", "add"): (False, False, False, True, False),
    ("issue", "depends", "remove"): (False, False, False, True, False),
    ("issue", "time", "list"): (False, False, False, False, False),
    ("issue", "time", "add"): (False, False, False, True, False),
    ("issue", "time", "delete"): (True, True, False, True, False),
    ("repo", "mirror", "list"): (False, False, False, False, False),
    ("repo", "mirror", "add"): (False, False, False, True, False),
    ("repo", "mirror", "remove"): (True, True, False, True, False),
    ("repo", "mirror", "sync"): (False, False, False, True, False),
    ("batch", "pr", "create"): (False, False, False, True, False),
}

_SAFETY_FALLBACK: tuple[bool, bool, bool, bool, bool] = (False, False, False, False, False)


def _build_safety(values: tuple[bool, bool, bool, bool, bool]) -> dict[str, bool]:
    """_SAFETY_FIELDS と同順のタプルを safety オブジェクトに変換する。"""
    return dict(zip(_SAFETY_FIELDS, values, strict=True))
...
def _build_command_schema(
    ...
    result: dict[str, Any] = {
        ...
        "safety": _build_safety(_SAFETY_MAP.get(key, _SAFETY_FALLBACK)),
    }
    return result
...
def _build_grandchild_command_schema(
    ...
    return {
        ...
        "safety": _build_safety(_GRANDCHILD_SAFETY_MAP.get(key, _SAFETY_FALLBACK)),
    }
