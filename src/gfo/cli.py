...
def create_parser() -> tuple[argparse.ArgumentParser, dict[str, argparse.ArgumentParser]]:
    ...
    parser.add_argument(
        ...
        metavar="REPO",
        help=_(
            "Specify target repository. Accepts: github.com/owner/repo, "
    ...
    pr_create.add_argument("--label", "-l", action="append", help=_("Label name (repeatable)"))
    pr_create.add_argument("--milestone", "-m", help=_("Milestone name"))
    pr_create.add_argument(
        "--fill", "-f", action="store_true", help=_("Use commit info for title and body")
    )
    ...
    _merge_method.add_argument(
        "--merge", "-m", action="store_true", help=_("Create a merge commit")
    )
    _merge_method.add_argument("--squash", "-s", action="store_true", help=_("Squash and merge"))
    ...
    pr_review_create.add_argument("--body", "-b", default="", help=_("Body"))
    ...
    pr_comment_create.add_argument("--body", "-b", required=True, help=_("Body"))
    ...
    issue_list.add_argument("--search", "-S", help=_("Filter by title/description"))
    ...
    repo_edit.add_argument("--description", "-d", help=_("Description"))
    ...
    release_create.add_argument("--title", "-t", default=None, help=_("Title"))
    release_create.add_argument("--notes", "-n", default="", help=_("Release notes"))
    ...
    release_edit.add_argument(
        "--prerelease", "-p", action="store_true", default=None, help=_("Mark as prerelease")
    )
    release_edit.add_argument(
    ...
    milestone_edit.add_argument("--title", "-t", help=_("Title"))
    milestone_edit.add_argument("--description", "-d", help=_("Description"))
    ...
    pr_edit.add_argument("--title", "-t", help=_("Title"))
    pr_edit.add_argument("--body", "-b", help=_("Body"))
    pr_edit.add_argument("--base", "-B", help=_("Base branch"))
    ...
    issue_edit.add_argument("--title", "-t", help=_("Title"))
    issue_edit.add_argument("--body", "-b", help=_("Body"))
    issue_edit.add_argument("--assignee", "-a", help=_("Assignee"))
    issue_edit.add_argument("--label", "-l", help=_("Label"))
    ...
    issue_edit.add_argument("--milestone", "-m", help=_("Milestone"))
    ...
    issue_comment_create.add_argument("--body", "-b", required=True, help=_("Body"))
    ...
    status_create.add_argument("--description", "-d", help=_("Description"))
    ...
    wiki_create.add_argument("--title", "-t", required=True, help=_("Title"))
    ...
    org_create.add_argument("--description", "-d", help=_("Description"))
    ...
    org_edit.add_argument("--description", "-d", help=_("Description"))
    ...
    batch_pr_create.add_argument("--title", "-t", required=True, help=_("Title"))
