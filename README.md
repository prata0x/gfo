...
>
> ⚠: Known issue; behavior may differ from the normal support contract.
>
> **Footnotes**:
...
> - Repo Fork (Gogs): The inherited Gitea endpoint is unavailable and may return an API error instead of `NotSupportedError`.
